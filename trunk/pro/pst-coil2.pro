%!
% PostScript prologue for pst-coil2.tex.
% Version 2.00, 04/12/28
% For distribution, see pstricks.tex.
%
/tx@CoilDict 40 dict def tx@CoilDict begin
/CoilLoop { 
  /t ED t sin AspectSin mul t 180 div AspectCos mul add t cos lineto 
} def
/Coil { 
  /Inc ED dup sin /AspectSin ED cos /AspectCos ED /ArmB ED /ArmA ED
...
/AltCoil { 
  /Inc ED dup sin /AspectSin ED cos /AspectCos ED /h ED /w ED
  ...
  EndAngle { CoilLoop } for EndAngle CoilLoop mtrx setmatrix 
} def
/ZigZag { 
  /ArmB ED /ArmA ED 2 div /w ED w mul /h ED /y1 ED /x1 ED /y0 ED
