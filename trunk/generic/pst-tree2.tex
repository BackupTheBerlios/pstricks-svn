...
\xdef\pstree@tspace{\number\pst@dimg}%
\ignorespaces}
\define@key[psset]{pst-tree}{treefit}{%
...
%
\define@key[psset]{pst-tree}{thistreefit}{%
  \@ifundefined{pstree@#1fit}%
    {\@pstrickserr{Bad `treefit' parameter value: `#1'}\@ehpa}%
...
\def\pstree@ii{%
  \ifnum\pstreelevel=\z@
    ...
    \psset[pst-tree]{shortput=tab}%
  \else\pst@@killglue\fi
  \begingroup
    \begingroup
      \def\pstree@node{%
        \xdef\pstree@next{%
...
{\pstree@thetree-\the\pstreelevel}{\number\pst@dimh}}%
\fi}
\define@key[psset]{pst-tree}{treemode}{%
  \pst@cntg=
  ...
  \ifcase\pst@cntg
    ...
    \or\let\pstree@do\pstree@right
    \or\let\pstree@do\pstree@up
    \or\let\pstree@do\pstree@left
  \fi}
\def\psk@treemode{0}
\let\pstree@do\pstree@down
\define@key[psset]{pst-tree}{treesep}{%
  \pssetlength\pst@dimg{#1}%
  \edef\psk@treesep{\number\pst@dimg}}%
...
\define@key[psset]{pst-tree}{treenodesize}{%
  \pssetlength\pst@dimg{#1}%
  \ifdim\pst@dimg<\z@
...
\define@key[psset]{pst-tree}{thistreenodesize}{%
  \pssetlength\pst@dimg{#1}%
  \ifdim\pst@dimg<\z@
  ...
  \fi}
\define@key[psset]{pst-tree}{levelsep}{%
  \pst@expandafter{\pst@ifstar\psset@@levelsep}{#1}\@nil}
\psset@@levelsep#1\@nil{%
...
\psset@@thislevelsep#1\@nil{%
  ...
  \fi}
\newif\ifpstreeflip
\define@key[psset]{pst-tree}{treeflip}{\@nameuse{pstreeflip#1}}
...
\pstree@outer
\newif\ifpsshowbbox
\define@key[psset]{pst-tree}{showbbox}{\@nameuse{psshowbbox#1}}%
...
\end@treenode}
%
\define@key[psset]{pst-tree}{fansize}{\pst@@getlength{#1}\psk@fansize}
...
\define@key[psset]{pst-tree}{tnheight}{\edef\psk@tnheight{#1}}
%\psset[pst-tree]{tnheight=\ht\strutbox}
\define@key[psset]{pst-tree}{tndepth}{\edef\psk@tndepth{#1}}
%\psset[pst-tree]{tndepth=\dp\strutbox}
\define@key[psset]{pst-tree}{tnpos}{%
  \def\pst@tempg{#1}%
  \ifx\pst@tempg\@empty
    \def\psk@tnpos{\ifcase\psk@treemode b\or r\or a\or l\fi}%
  \else
